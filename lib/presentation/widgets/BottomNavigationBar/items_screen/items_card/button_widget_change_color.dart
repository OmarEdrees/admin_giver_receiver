...
class ButtonWidgetChangeColor extends StatefulWidget {
  final IconData icon;
  final String title;
  ...
  @override
  State<ButtonWidgetChangeColor> createState() =>
      _ButtonWidgetChangeColorState();
}

class _ButtonWidgetChangeColorState extends State<ButtonWidgetChangeColor> {
