...
import 'package:admin_giver_receiver/logic/services/supabase_services.dart';
import 'package:admin_giver_receiver/logic/services/variables_app.dart';
import 'package:admin_giver_receiver/presentation/screens/auth/sign_up_screen.dart';
import 'package:admin_giver_receiver/presentation/widgets/auth/sign_up_in_SocialButton.dart';
                              ...
                              GestureDetector(
                                onTap: () async {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    try {
                                      await SupabaseServices().signInAdmin(
                                        context: context,
